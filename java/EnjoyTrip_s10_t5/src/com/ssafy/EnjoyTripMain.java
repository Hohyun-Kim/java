...
public class EnjoyTripMain {
	...
	private void attractionList() throws NumberFormatException, IOException {
		...
		List<AttractionInfoDto> attraction_list = AttractionServiceImpl.getAttractionService().attractionList(attractionInfoDto);
		for (AttractionInfoDto attractionInfoDto2 : attraction_list) {
			System.out.println(attractionInfoDto2);
		}
	...
	private void attractionSearch() throws IOException {
		...
		List<AttractionInfoDto> attraction_list = AttractionServiceImpl.getAttractionService().searchByTitle(title, sidoCode);
		for (AttractionInfoDto attractionInfoDto : attraction_list) {
