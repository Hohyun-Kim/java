...
public class A0010_KIMHOHYUN_PARKYEONSEO {
	...
	static final float[][][] HOLE_BORDER = { {{0, 3}, {3, 0}}, {{124, 0}, {130, 0}}, {{251, 0}, {254, 3}},
			{{0, 124}, {3, 127}}, {{124, 127}, {130, 127}}, {{251, 127}, {254, 124}} };
	
	static final double R = 5.7;
	static float[][] balls;
	static int[] ball_idx;
...
//				target ball마다 가능한 hole 찾아주기
				...
				if(targetBall.idx == 1 || targetBall.idx == 4 ) {
...
//				}
				...
				power = (float) ((float) distance - Math.sqrt(distance) * 0.5);
